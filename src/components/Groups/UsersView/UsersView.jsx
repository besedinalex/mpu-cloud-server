...
class UsersView extends Component {
  ...
  handleAdd = event => {
    ...
    addGroupUser(this.props.group, this.state.email, this.state.access).then(this.getGUsers());
  };
            ...
            <div className="modal-content">
              ...
              <div style={{ marginBottom: "16px" }}>
                <div class="col-auto my-1">
                  <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" onChange={this.handleAccessChange}>
