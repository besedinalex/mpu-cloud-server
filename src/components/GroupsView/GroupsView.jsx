...
class GroupsView extends Component {
    ...
    render() {
        return (
            <div>
                <div hidden={!this.state.isDialogOpen} className="modal fade" id="exampleModal" tabIndex="-1"
                     role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">Создать новый проект</h5>
                                <button onClick={this.handleCloseDialog} type="button" className="close"
                                    ...
                                    <div className="input-group">
                                        <div className="custom-file">
                                            <input
                                                ...
                                                required=""
                                            />
                                            <label style={{textAlign: 'left'}} className="custom-file-label"
                            ...
                            <div className="modal-footer">
                                <button onClick={this.handleCloseDialog} type="button" className="btn btn-secondary"
                        ...
                        <div class="my-3 p-3 bg-white rounded shadow-sm">
                            ...
                            <div className="inline">
                                <FontAwesomeIcon
                                    ...
                                    data-toggle="modal"
                                    data-target="#exampleModal" icon={faFolderPlus} />
                            </div>
