        ...
        return (
            <tr onMouseOver={this.handleMouseOver} onMouseOut={this.handleMouseOut}>
                ...
                <td onClick={this.handleModelClick} className="filename">
                    <img src="https://cdn3.iconfinder.com/data/icons/ikooni-outline-file-formats/128/files2-48-512.png"
                         style={{position: "relative"}} width="35px" alt="" />
                    {this.props.filename}
                </td>
                ...
                <td className="tools" style={{width: '120px'}}>
                    <div style={{display: 'flex', justifyContent: 'space-between', marginTop: '4px'}}
                        ...
                        <FontAwesomeIcon onClick={this.handleDownloadClick} className="tool download"
